<?php
/**
 * Title: Header for interior pages (1400px wide)
 * Slug: templeton-block-theme/header-interior
 * Categories: header
...
<div class="wp-block-group alignfull has-background" style="background-color:#222222;margin-top:0px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-button has-hover-darken"><a class="wp-block-button__link has-contrast-color has-accent-background-color has-text-color has-background wp-element-button">Schedule a Tour</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
